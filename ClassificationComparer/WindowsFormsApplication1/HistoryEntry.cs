...
namespace HistoryClassifier
{
    ...
    class HistoryEntry : IEquatable<HistoryEntry>
    {
        ...
        public bool Equals(HistoryEntry other){
            ...
            if(!(other.ApplicationName.Equals(this.ApplicationName))){
                return false;
            }

            if(!(other.VersionNumber.Equals(this.VersionNumber))){
                return false;
            }

            
            if(!(other.entry.Equals(this.entry))){
                return false;
            }
       ...
       public bool OriginallyMerged(HistoryEntry other){
            ...
            if(!(other.original_text.Equals(this.original_text))){
                return false;
            }
